  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {currentSection === 2 && (
          <CarInspection
            data={formData.carInspection}
            updateData={(data) => updateFormData("carInspection", data)}
          />
        )}
        {currentSection === 3 && (
          <KeysDocumentsAccessories
            ...
            updateData={(data) =>
              updateFormData("keysDocumentsAccessories", data)
            }
          />
        )}
        {currentSection === 4 && (
          <FinalReview
            data={formData.finalReview}
            updateData={(data) => updateFormData("finalReview", data)}
          />
        )}
