...
export default function Header() {
  ...
  return (
    <div>
      <div
        className={`absolute overflow-x-hidden  z-10 top-15 border border-border left-0 w-[100%] bg-white dark:bg-background flex items-center justify-between py-2 scrollbar-hide `}
      >
