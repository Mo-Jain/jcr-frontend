  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-600 mb-4">
        Conduct a final review of the vehicle&apos;s condition with the client,
        ensuring all points are addressed, and obtain the clients acknowledgment
        and signature confirming the vehicle&apos;s return in the agreed
        condition.
      </p>
      ...
      <div>
        <p>
          We&apos;d love to hear your feedback! Please leave us a review on
          Google!
        </p>
        <p>
      ...
      <div>
        ...
        <div className="flex items-center space-x-2 mt-2">
          <Checkbox
            id="staffApproval"
            checked={data.staffApproval || false}
            onCheckedChange={handleCheckboxChange}
          />
          <Label htmlFor="staffApproval">
            We, Jain Car Rentals hereby accept that the car is in good condition
            and has been returned back to us
          </Label>
        </div>
      </div>
    </div>
